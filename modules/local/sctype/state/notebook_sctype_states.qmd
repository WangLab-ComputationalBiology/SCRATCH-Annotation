...
:::{.callout-tip}
The @fig-module-score shows stacked violin plots illustrate gene expression distributions for multiple genes across cell types.
:::
...
:::{.callout-tip}
The @fig-feat-markers shows stacked violin plots illustrate gene expression distributions for multiple genes across cell types.
:::
...
:::{.callout-tip}
The @fig-violin shows stacked violin plots illustrate gene expression distributions for multiple genes across cell types.
:::
...
```
:::{.callout-tip}
The @fig-bubble shows stacked violin plots illustrate gene expression distributions for multiple genes across cell types.
:::
