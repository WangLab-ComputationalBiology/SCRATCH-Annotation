...
cell_list <- cell_markers_database[
  cell_markers_database$cell_annotation %in% sctype_best_scored$type, c("cell_type", "cell_annotation", "markers")]

cell_list <- cell_list %>%
  group_by(cell_type, cell_annotation) %>%
...
if(auto_save) {
  ...
  saveRDS(seurat_object, file = paste0('./data/', project_name, '_', input_cell_population, '_subtype_annotation.RDS'))
