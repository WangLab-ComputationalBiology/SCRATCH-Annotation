---
title: "Module - Sctype Annotation"
execute:
  cache: true
  freeze: auto
format:
...
params:
  ...
  project_object: '/Users/affaustino/Projects/SCRATCH-Annotation/test/Yost_main_stratification_object.RDS'
...
gene_sets_prepare <- function(path_to_db_file, cell_type){
  ...
  cell_markers$geneSymbolmore1 = gsub("///",",",cell_markers$geneSymbolmore1);cell_markers$geneSymbolmore1 = gsub(" ","",cell_markers$geneSymbolmore>
  cell_markers$geneSymbolmore2 = gsub("///",",",cell_markers$geneSymbolmore2);cell_markers$geneSymbolmore2 = gsub(" ","",cell_markers$geneSymbolmore>

  gs = lapply(1:nrow(cell_markers), function(j) gsub(" ","",unlist(strsplit(toString(cell_markers$geneSymbolmore1[j]),",")))); names(gs) = cell_mark>
  gs2 = lapply(1:nrow(cell_markers), function(j) gsub(" ","",unlist(strsplit(toString(cell_markers$geneSymbolmore2[j]),",")))); names(gs2) = cell_ma>
