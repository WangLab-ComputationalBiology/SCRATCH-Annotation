...
output_object  = "{work_directory}/data/{object_label}".format(work_directory = work_directory, object_label = "celltypist_annotation.h5ad")
...
:::{.callout-tip}
The @fig-umap-fine shows Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
:::
